...
export default function Value() {
    ...
    return (
        <section className={'mx-auto max-w-screen-2xl'}>
            <div className={'p-6 flex justify-center items-center gap-x-8'}>
                <article className={'flex-1'}>
                    <div
                        className={'w-[30rem] h-[35rem] overflow-hidden rounded-t-[15rem] border-solid border-8 border-[#E8E8E8FF]'}
                    >
                        <img src="/assets/real-estate/value.png" alt="Value image"/>
                    </div>
                </article>
                <article className={'flex flex-1 flex-col justify-center items-start gap-y-2'}>
                            ...
                            data.map((item, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <AccordionItemHeading>
                                            <AccordionItemButton
                                                className={'flex justify-between items-center bg-white p-4 w-full'}
                                            >
                                                <AccordionItemState>
                                                    {
                                                        ({expanded}) => (
                                                ...
                                                <span className={'text-secondary font-bold text-[1.1rem]'}>
                                                {item.heading}
                                            </span>
                                                <div
                                                    className={'flex justify-center items-center p-2.5 bg-[#eeeeff] rounded-md text-ternary'}
